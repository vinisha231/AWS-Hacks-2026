    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col">
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center px-6 py-20 max-w-3xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-3 items-center">
          ...
          <p className="text-stone-600 text-sm">No name. No email. No account.</p>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-24 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Pillar
            ...
            tag="Gemini AI"
            title="Reads what you're feeling"
            body="Speak into Ember when a craving hits. Gemini detects your emotional state in real-time — which hormone is depleted, how high the risk — and generates the exact 7-minute activity to intercept it."
          />
          ...
          <Pillar
            ...
            tag="ElevenLabs"
            title="Speaks in a voice you love"
            body="Clone your mom's voice. Your sponsor's. Your daughter's. Whoever keeps you grounded. Ember speaks your spark activity in that voice — because hearing the right person makes every difference."
          />
          ...
          <Pillar
            ...
            tag="Solana"
            title="Makes your promise unbreakable"
            body="Every craving survived is minted on-chain. Your commitment isn't just a number in a database — it's an immutable record on Solana devnet. The blockchain holds your streak even when willpower doesn't."
          />
          ...
          <Pillar
            ...
            body="No name. No email. No phone number. Auth0 gives you a cryptographic identity that stays yours — completely anonymous. Recovery is hard enough without surrendering your privacy too."
          />
        </div>
      </section>
