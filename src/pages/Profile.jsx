      ...
      <div className="max-w-screen-xl mx-auto px-6 lg:px-12 py-12">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col gap-6">
                ...
                {CURRENT_BENEFITS_OPTIONS.map(({ value, label }) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {selected && (
                        <svg className="w-4 h-4 text-white shrink-0" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M16.707 5.293a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                        </svg>
                      )}
                    </button>
                  )
            ...
            {/* Actions */}
            <div className="reveal flex flex-col sm:flex-row items-center gap-3 pt-2">
              <button
                type="button"
                onClick={save}
                disabled={!dirty}
