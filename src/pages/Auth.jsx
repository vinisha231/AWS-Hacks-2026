...
export default function Auth() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.message?.includes('already registered')) setError('Username already taken. Try another.')
      else if (err.message?.includes('Invalid login')) setError('Wrong username or password.')
          ...
          <div className="text-center">
            ...
            <p className="text-stone-500 text-sm">
              {mode === 'login'
                ...
                : 'No email. No phone. Just a username you choose.'}
            </p>
          </div>

          {/* Warning banner (signup only) */}
          {mode === 'signup' && (
            <div className="bg-amber-500/8 border border-amber-500/25 rounded-xl p-4 flex gap-3">
              ...
              <p className="text-amber-300/80 text-xs leading-relaxed">
                ...
                If you forget your username or password, you'll need to create a new account.
